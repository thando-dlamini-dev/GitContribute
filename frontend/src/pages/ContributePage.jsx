...
const ContributePage = () => {
  const { generateReposWithAi, user, isLoading, techStack, error } = useAuthStore();
  ...
  if (isLoading) {
    return (
      <div className='flex flex-col items-center justify-center min-h-screen'>
        ...
        <p className="mt-4 text-gray-600">Analyzing your repositories...</p>
      </div>
    );
  }
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-gray-600">
                Let's analyze your tech stack to find repositories for you to contribute to.
              </p>
            </div>
            ...
            >
              {isLoading ? 'Analyzing...' : 'Analyze My Tech Stack'}
            </button>
          </div>
        ...
        {sortedTechStack.length > 0 ? (
          <div className="p-6 bg-white rounded-lg shadow-md">
            ...
            <p className="mb-6 text-gray-600">
              Based on your {sortedTechStack.length} technologies:
            </p>
